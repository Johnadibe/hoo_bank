...
const FeatureCard = ({ icon, title, content, index }) => (
  <div className={`flex flex-row p-6 rounded-[20px] ${index !== features.length - 1 ? 'mb-6' : 'mb-0'} feature-card`}>
    ...
    <div className="flex flex-1 flex-col ml-3">
      <h4 className="text-white font-semibold font-poppins text-[18px] leading-[23px] mb-1">
        {title}
      </h4>
      <p className="text-white font-normal font-poppins text-dimWhite leading-[24px] mb-1">
        {content}
      </p>
    </div>
  </div>
...
const Business = () => (
    <section id="features" className={layout.section}>
      {/* Left Card Div */}
      <div data-aos="fade-down" className={layout.sectionInfo}>
